...
return [
    ...
    */
    ...
    'custom' => [
        'kd_penyakit' => [
            'required' => 'Kolom Kode Penyakit harus diisi',
            'unique' => 'Kode sudah terpakai',
        ],

        'nm_penyakit' => [
            'required' => 'Kolom Nama Penyakit harus diisi',
        ],

        'def_penyakit' => [
            'required' => 'Kolom Definisi Penyakit harus diisi',
        ],

        'sol_penyakit' => [
            'required' => 'Kolom Solusi Penyakit harus diisi',
        ],
